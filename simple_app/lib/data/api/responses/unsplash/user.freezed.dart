...
class _$UserTearOff {
  ...
  _User call({required String username, required ProfileImage profileImage}) {
    return _User(
      username: username,
...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call({String username, ProfileImage profileImage});
...
class _$_User implements _User {
  _$_User({required this.username, required this.profileImage});
...
abstract class _User implements User {
  factory _User(
      {required String username, required ProfileImage profileImage}) = _$_User;
